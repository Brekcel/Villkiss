...
use crate::{FrameBuffer, ImageView, Pipeline, Shader, Swapchain};
...
impl<'a> RenderPass<'a> {
    ...
    pub fn create_framebuffer_from_chain(&self) -> FrameBuffer {
        FrameBuffer::from_swapchain(self)
    }
    ...
    pub fn create_pipeline(&'a self, shader: &'a Shader) -> Pipeline<'a> {
